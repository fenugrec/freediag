...
/* fill & init new dl0d */
static int dumb_new(struct diag_l0_device *dl0d) {
 ...
 */
static int dumb_fastinit(struct diag_l0_device *dl0d) {
	struct dumb_device *dev = dl0d->l0_int;
	int rv=0;
...
static void dumb_Lline(struct diag_l0_device *dl0d, uint8_t ecuaddr) {
	/*
 ...
 *
 */
static int dumb_slowinit(struct diag_l0_device *dl0d, struct diag_l1_initbus_args *in,
                         struct dumb_device *dev) {
	uint8_t cbuf[10];
	int rv;
	unsigned int tout;
 ...
 */
static int dumb_initbus(struct diag_l0_device *dl0d, struct diag_l1_initbus_args *in) {
...
static int dumb_send(struct diag_l0_device *dl0d,
...
static int dumb_recv(struct diag_l0_device *dl0d,
 ...
 * ret 0 if ok
 */
static int dumb_setspeed(struct diag_l0_device *dl0d,
...
static uint32_t dumb_getflags(struct diag_l0_device *dl0d) {
	struct dumb_device *dev;
	int flags=0;
