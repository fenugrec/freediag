...
static int dt_send(struct diag_l0_device *dl0d,
...
static int dt_new(struct diag_l0_device *dl0d) {
...
static void dt_close(UNUSED(struct diag_l0_device *dl0d)) {
	return;
}
...
static int dt_recv(struct diag_l0_device *dl0d,
 ...
 */
static int dt_setspeed(struct diag_l0_device *dl0d,
...
static uint32_t dt_getflags(UNUSED(struct diag_l0_device *dl0d)) {
