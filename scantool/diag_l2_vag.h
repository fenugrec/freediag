...
#define KWP1281_T_R1_MIN                                                                  \
	80 // between Init Byte and Synchronization Byte (ECU -> Scan
	   // Tool)
...
#define KWP1281_T_R5_MIN                                                                  \
	25 // time between KW2 Complement and 1st ECU message (ECU -> Scan Tool)
#define KWP1281_T_R5_MAX 50
#define KWP1281_T_RK                                                                      \
	231 // time ECU waits before re-sending the Sync Byte if KW2 Complement was
	    // incorrect (ECU -> Scan Tool)
...
#define KWP1281_T_R7_MIN                                                                  \
	1 // time ECU waits before sending next byte to Scan Tool this is 0.5ms,
	  // actually...
#define KWP1281_T_R7_MAX 50
#define KWP1281_T_R8                                                                      \
	55 // timeout while waiting for a message byte (ECU and Scan Tool; R6_MAX+5 or
	   // R7_MAX+5)
