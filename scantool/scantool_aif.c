...
static void OkToApp (void) {
	toApp(FREEDIAG_AIF_OK_RETURN);
}
static void BadToApp(void) {
...
static void aif_watch(void *data) {
	(void) data; BadToApp();
}
static void aif_clear_dtc(void *data) {
	(void) data; BadToApp();
}
static void aif_ecus(void *data) {
	(void) data; BadToApp();
}
static void aif_test(void *data) {
	(void) data; BadToApp();
}
static void aif_diag(void *data) {
	(void) data; BadToApp();
}
static void aif_vw(void *data) {
	(void) data; BadToApp();
}
static void aif_dyno(void *data) {
	(void) data; BadToApp();
}
