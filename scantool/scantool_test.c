...
const struct cmd_tbl_entry test_cmd_table[] = {
	{"help", "help [command]", "Gives help for a command", cmd_test_help, 0, NULL},
	{"?", "? [command]", "Gives help for a command", cmd_test_help, FLAG_HIDDEN, NULL},
	{"rvi", "rvi", "Send request vehicle info commands to the ECU", cmd_test_rvi, 0,
	 NULL},
	{"cms", "cms", "Get test results for continuously monitored systems", cmd_test_cms,
	 0, NULL},
	{"ncms", "ncms", "Get test results for non-continuously monitored systems",
	 cmd_test_ncms, 0, NULL},
	{"readiness", "readiness", "Do readiness tests", cmd_test_readiness, 0, NULL},
...
get_vit_info(struct diag_l3_conn *d_conn, uint8_t itype, uint8_t *obuf, unsigned buflen) {
	...
	/* Now request the VIN */
	rv = l3_do_j1979_rqst(d_conn, 9, itype, 0, 0, 0, 0, 0,
...
cmd_test_readiness(UNUSED(int argc), UNUSED(char **argv)) {
	...
	const char *test_names[] = {"Misfire Monitoring",
	...
	rv = l3_do_j1979_rqst(d_conn, 1, 1, 0x00, 0x00, 0x00, 0x00, 0x00,
